'reinit'
'sdfopen c:/grads/dados/n2004/fevereiro/air.nc'
'sdfopen c:/grads/dados/n2004/fevereiro/rhum.nc'
'sdfopen c:/grads/dados/n2004/fevereiro/uwnd.nc'
'sdfopen c:/grads/dados/n2004/fevereiro/vwnd.nc'
...
'q time'
res=subwrd(result,3)
date=substr(res,1,12)
'set grads off'
'define temp=air-273'
'define a=-2937.4/air-4.9283*log10(air)+23.5470'
'define es=pow(10,a)'
'define e=(es*rhum.2)/100'
'define dewp=(186.4905-237.3*log10(e))/(log10(e)-8.2859)'
'define spd=mag((uwnd.3*1.94),(vwnd.4*1.94))'
'define dir=(180*atan2(vwnd.4,uwnd.3)/3.141592654)+180'
rn=plotskew(temp,dewp,spd,dir)
